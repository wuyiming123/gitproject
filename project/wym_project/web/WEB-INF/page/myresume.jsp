        ...
        $(function () {
            $("#addres").click(function () {
                ...
                $("body").append(
                    ...
                    "<td><input required style='border: 0px' type='text' name='r_nation' maxlength='8' placeholder='最多输入八个字符' required></td></tr>" +
                    "<tr><td>籍贯：</td><td><input required style='border: 0px' type='text' maxlength='8' placeholder='最多输入八个字符' name='r_nativeplace' required></td>" +
                    "<td>毕业院校：</td><td><input required style='border: 0px' type='text' name='r_graduteschool' maxlength='20' placeholder='最多输入20个字符' required></td></tr>" +
                    "<tr><td>政治面貌：</td><td><input required style='border: 0px' type='text' name='r_politics' maxlength='10' placeholder='最多输十个字符' required></td>" +
                    "<td>专业:</td><td><input required style='border: 0px' type='text' name='r_major' maxlength='20' placeholder='最多输入20个字符' required></td></tr>" +
                    "<tr><td>学历：</td><td><input required style='border: 0px' type='text' name='r_education' maxlength='10' placeholder='最多输入十个字符' required></td>" +
                    "<td>邮政编码：</td><td><input required style='border: 0px' type='text' maxlength='6' placeholder='最高输入6位数' name='r_zipcode' required></td></tr>" +
                    "<tr><td>电话号码：</td><td><input required style='border: 0px' type='text' maxlength='11' placeholder='最高输入11位数字' name='r_phone' required></td>" +
                    "<td>E-MAIL</td><td><input required style='border: 0px' type='text' name='r_email' placeholder='' required></td></tr>" +
